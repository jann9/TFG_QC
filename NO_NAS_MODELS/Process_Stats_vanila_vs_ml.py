    ...
    for node_size in [10, 12, 15, 20, 25]:
        for ml_tech in ["Vanilla","xgboost", "MLP"]:
            ...
            for exe in range(1, 31):
                df = pd.read_csv(f"Models/qaoa_vs_ml/V{version}/execution_" + str(exe) + f"/Models/qaoa_vs_ml/V{version}/execution_" + str(exe) +"/vanila_vs_ml.csv")
...
if __name__ == "__main__":
  ...
  results_formatted.to_csv(f'Models/qaoa_vs_ml/V{version}/statistics_vanilla_vs_ml.csv')
