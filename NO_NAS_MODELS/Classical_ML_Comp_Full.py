...
model_list = ['xgboost', 'MLP','MLP_NAS']
    ...
    for num_nodes in node_sizes:
        ...
        for model_name in model_list:
            ...
            if model_name=="MLP":
                ...
                model_path = f"Models/qaoa_vs_ml/V{version_qaoa_vs_ml}/execution_{str(sys.argv[1])}/{model_name}_model_full.pkl"
            elif model_name=="MLP_NAS":
                model_path = f"Models/qaoa_vs_ml/V{version_qaoa_vs_ml}/execution_{str(sys.argv[1])}/MLP_model_nas_full.pkl"
