...
output_file = "Models/XGB_results.txt"
...
for node_size in node_sizes:
    model_path = f"Models/xgboost_model_{node_size}.pkl"
    dataset_path = os.path.join(base_dataset_dir, f"dataset_{node_size}_nodes.csv")
...
full_model_path = "Models/xgboost_model_full.pkl"
